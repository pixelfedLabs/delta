      ...
      <div class="py-5">
        <div class="py-5 my-5 bg-skew d-flex align-items-center justify-content-center shadow" style="min-height: 40rem;">
          <div class="container text-center">
            ...
            <p class="h3 font-ptsn">Run your <a href="https://docs.pixelfed.org/running-pixelfed/">own server</a>, or <a href="/join">join one</a></p>
          </div>
        </div>
      </div>
      <div class="d-block py-5"></div>
      ...
      <div class="row">
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small">
            ...
            <li><a class="text-muted" href="https://docs.pixelfed.org/running-pixelfed/">Install Pixelfed</a></li>
